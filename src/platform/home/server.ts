/**
 * Standalone stdio MCP server entry point for the home app.
 *
 ...
 *
 * Its tool schemas come from `../schemas/home.ts`, so this server and the
 * in-process source beside it share one source of truth.
 */
...
// the in-process `src/platform/home/source.ts` (already workspace-aware). Post
