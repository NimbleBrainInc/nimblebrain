...
const FALLBACK_HTML =
  "<html><body><p>UI not built. Run: cd src/bundles/files/ui && bun install && bun run build</p></body></html>";

const UI_PATH = resolve(
  import.meta.dirname ?? __dirname,
  "../../../bundles/files/ui/dist/index.html",
);

/**
 * Read the files bundle's built UI HTML on each call. See
