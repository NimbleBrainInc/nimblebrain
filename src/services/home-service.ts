...
import type { ActivityInput, ActivityOutput, BriefingInput, BriefingOutput } from "./home-types.ts";
...
export class HomeService {
  constructor(
    ...
    eventManager.onEvent((event: string) => {
      if (event === "data.changed" || event.startsWith("bundle.")) {
