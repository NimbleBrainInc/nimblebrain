 ...
 *
 * Advertised by the platform (acting as MCP Client to each connector) in the
 ...
 * collisions. Connectors read this to decide whether to use the
 ...
 * a breaking change. Connectors check `caps.read.enabled` for "can I read?" and
