...
.header-title {
  font-family: var(--nb-font-heading, system-ui, sans-serif);
  font-size: 22px; font-weight: 500; letter-spacing: -0.025em; line-height: 1.3;
}
.header-lede { font-size: 14px; color: var(--color-text-secondary, #5c5c66); margin-top: 2px; }
...
.section-header {
  ...
  color: var(--color-text-secondary, #5c5c66); margin: 16px 0 8px;
}
...
.auto-card-schedule { font-size: 12px; color: var(--color-text-secondary, #5c5c66); margin-top: 2px; }
.auto-card-meta {
  display: flex; gap: 12px; flex-wrap: wrap; margin-top: 6px;
  font-size: 12px; color: var(--color-text-secondary, #5c5c66);
}
...
.btn {
  display: inline-flex; align-items: center; gap: 4px;
  padding: 4px 10px; border: 1px solid var(--color-border-primary, #e4e4e7);
...
.btn-danger {
  border-color: color-mix(in srgb, var(--nb-color-danger, #c02a24) 40%, transparent);
  color: var(--nb-color-danger, #c02a24);
}
.btn-danger:hover { background: var(--nb-color-danger, #c02a24); color: #fff; border-color: var(--nb-color-danger, #c02a24); }
...
.run-row:hover { background: color-mix(in srgb, var(--color-border-primary, #e4e4e7) 30%, transparent); }
.run-name { font-weight: 500; flex: 1; min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.run-time { font-size: 12px; color: var(--color-text-secondary, #5c5c66); flex-shrink: 0; }
.run-duration { font-size: 12px; color: var(--color-text-secondary, #5c5c66); flex-shrink: 0; min-width: 48px; text-align: right; }
...
.empty-state { text-align: center; padding: 64px 24px; color: var(--color-text-secondary, #5c5c66); }
...
.skel {
  background: var(--color-border-primary, #e4e4e7);
  border-radius: var(--border-radius-sm, 0.5rem);
...
.error-banner {
  ...
  background: color-mix(in srgb, var(--nb-color-danger, #c02a24) 10%, transparent);
  border: 1px solid color-mix(in srgb, var(--nb-color-danger, #c02a24) 25%, transparent);
  border-radius: var(--border-radius-sm, 0.5rem);
  color: var(--nb-color-danger, #c02a24); font-size: 13px;
}
...
.confirm-desc { font-size: 13px; color: var(--color-text-secondary, #5c5c66); margin-bottom: 16px; line-height: 1.5; }
...
.back-btn {
  ...
  width: 28px; height: 28px; border: 1px solid var(--color-border-primary, #e4e4e7);
...
.detail-desc {
  font-size: 13px; color: var(--color-text-secondary, #5c5c66);
...
.detail-section-title {
  font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;
  color: var(--color-text-secondary, #5c5c66); margin-bottom: 8px;
}
...
.detail-config-label {
  ...
  color: var(--color-text-secondary, #5c5c66); margin-bottom: 2px;
}
.detail-config-value {
  font-size: 13px; font-weight: 500; word-break: break-word;
}
.detail-config-value.muted { color: var(--color-text-secondary, #5c5c66); font-weight: 400; font-style: italic; }
...
.rail {
  overflow-y: auto;
  border-right: 1px solid var(--color-border-primary, #e4e4e7);
  background: var(--color-background-primary, #ffffff);
  padding-bottom: 12px;
}
.rail-section {
...
.rail-auto-item:hover, .rail-run-item:hover { background: color-mix(in srgb, var(--color-border-primary, #e4e4e7) 30%, transparent); }
...
.rail-auto-name { font-size: 13px; font-weight: 500; color: var(--color-text-primary, #09090b); }
.rail-auto-sub { font-size: 11px; color: var(--color-text-secondary, #5c5c66); }
...
.rail-run-name { font-weight: 500; flex: 1; min-width: 0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: var(--color-text-primary, #09090b); }
.rail-run-time { font-size: 11px; color: var(--color-text-secondary, #5c5c66); flex-shrink: 0; }
.rail-run-snippet {
  font-size: 12px; color: var(--color-text-secondary, #5c5c66);
  margin-left: 16px;
...
.legend { display: inline-flex; gap: 10px; font-size: 10px; font-weight: 400; text-transform: none; letter-spacing: 0; color: var(--color-text-secondary, #5c5c66); }
...
.reader-empty {
  ...
  height: 100%; padding: 48px 32px; text-align: center; color: var(--color-text-secondary, #5c5c66);
}
.reader-empty-title {
  font-family: var(--nb-font-heading, system-ui, sans-serif);
  font-size: 17px; font-weight: 500; letter-spacing: -0.02em;
  color: var(--color-text-primary, #09090b); margin-bottom: 8px;
}
...
.reader-head-title { display: flex; align-items: center; gap: 7px; font-size: 12px; color: var(--color-text-secondary, #5c5c66); flex-wrap: wrap; }
.reader-head-name {
  background: none; border: none; padding: 0; font: inherit; cursor: pointer;
  color: var(--color-text-primary, #09090b); font-weight: 600;
...
.reader-head-status { color: var(--color-text-secondary, #5c5c66); }
.reader-head-sep, .reader-head-dot { color: var(--color-border-primary, #e4e4e7); margin: 0 2px; }
.reader-head-tag {
  font-size: 10px; padding: 1px 6px; border-radius: 10px;
  background: color-mix(in srgb, var(--color-text-secondary, #5c5c66) 12%, transparent);
  color: var(--color-text-secondary, #5c5c66); font-weight: 500;
...
.reader-error-label { font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; color: var(--nb-color-danger, #c02a24); margin-bottom: 6px; }
.reader-error-body {
...
.reader-section-label {
  font-size: 11px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;
  color: var(--color-text-secondary, #5c5c66); margin-bottom: 6px; cursor: default;
}
...
.reader-activity-name { font-family: var(--font-mono, ui-monospace, monospace); color: var(--color-text-primary, #09090b); }
.reader-activity-ms { margin-left: auto; color: var(--color-text-secondary, #5c5c66); font-size: 11px; }
...
.reader-footer-meta {
  ...
  font-size: 11px; color: var(--color-text-secondary, #5c5c66);
}
...
.out-md blockquote {
  ...
  border-left: 3px solid var(--color-border-primary, #e4e4e7);
  color: var(--color-text-secondary, #5c5c66);
}
.out-md hr { border: none; border-top: 1px solid var(--color-border-primary, #e4e4e7); margin: 18px 0; }
.out-md table { border-collapse: collapse; margin: 10px 0; }
.out-md th, .out-md td { border: 1px solid var(--color-border-primary, #e4e4e7); padding: 6px 10px; font-size: 13px; text-align: left; }
.out-md th { background: var(--color-background-primary, #ffffff); font-weight: 600; }
...
.template-card-desc { font-size: 11px; color: var(--color-text-secondary, #5c5c66); line-height: 1.35; }
...
.reader-back {
  ...
  width: 36px; height: 36px; border: 1px solid var(--color-border-primary, #e4e4e7);
  border-radius: 50%; background: transparent; cursor: pointer;
  color: var(--color-text-secondary, #5c5c66);
