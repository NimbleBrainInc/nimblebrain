...
|-------|-------|------|---------|
| `--color-background-primary` | `#ffffff` | `#000000` | Page background |
| `--color-background-secondary` | `#ffffff` | `#0e0e10` | Card / panel backgrounds |
| `--color-background-tertiary` | `#f4f4f5` | `#161618` | Subtle / nested backgrounds |
| `--color-text-primary` | `#09090b` | `#fafafa` | Body text |
| `--color-text-secondary` | `#5c5c66` | `#9b9ba4` | Captions, metadata, placeholders |
| `--color-text-tertiary` | `#6b6b73` | `#82828c` | De-emphasized text |
| `--color-text-accent` | `#0055FF` | `#4d90ff` | Links, primary buttons, AI accents (load-only — does not refresh on toggle) |
| `--color-border-primary` | `#e4e4e7` | `#232326` | Borders, dividers |
| `--color-border-secondary` | `#e4e4e7` | `#232326` | Secondary borders |
| `--color-ring-primary` | `#0055FF` | `#4d90ff` | Focus rings |

### Typography (ext-apps spec)

| Token | Value | Use for |
|-------|-------|---------|
| `--font-sans` | `'Hanken Grotesk', system-ui, sans-serif` | Body font |
...
| Token | Light | Dark | Use for |
|-------|-------|------|---------|
| `--nb-color-accent-foreground` | `#ffffff` | `#000000` | Text on accent backgrounds |
| `--nb-color-danger` | `#c02a24` | `#f0736a` | Errors, destructive actions |
| `--nb-color-success` | `#0f7a4f` | `#3fbf85` | Success indicators |
| `--nb-color-warning` | `#8a5f0a` | `#e0aa3c` | Warning indicators |
| `--nb-color-processing` | `#6d3ecf` | `#a68bfa` | In-progress / processing state |
| `--nb-color-processing-light` | `#f0ecfd` | `#161234` | Processing background |
| `--nb-color-info-light` | `#eaf0ff` | `#0b1a33` | Info background |
| `--nb-font-heading` | `'Hanken Grotesk', system-ui, sans-serif` | same | Heading font |
