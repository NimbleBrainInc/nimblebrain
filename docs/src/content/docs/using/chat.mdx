...
For an at-a-glance view of everything equipping the conversation, open the **In context** panel from the chat header. It shows the skills loaded for the latest turn, each with its scope and token cost, and a link to manage your skills.
