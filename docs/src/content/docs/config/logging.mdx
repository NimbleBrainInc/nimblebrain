...
```json
{"ts":"2026-03-25T14:30:00.123Z","event":"bundle.installed","serverName":"postgres","connectorName":"@nimblebraininc/postgres","version":"1.2.0"}
```
...
**Connector lifecycle** — `bundle.installed`, `bundle.uninstalled`. Track connectors entering and leaving the workspace.

```json
{"ts":"2026-03-25T14:30:00.123Z","event":"bundle.installed","wsId":"ws_product","serverName":"com-example-postgres","connectorName":"https://mcp.example.com/mcp","version":"remote (12 tools)"}
```
...
cat ~/.nimblebrain/logs/workspace/2026-03-25.jsonl \
  | jq 'select(.event == "bundle.installed") | {connectorName, version}'
