...
```json
{"ts":"2026-03-25T14:30:00.123Z","event":"bundle.installed","wsId":"ws_product","serverName":"com-example-postgres","bundleName":"https://mcp.example.com/mcp","version":"remote (12 tools)"}
```
