...
Managed-connector providers. A **managed-connector provider** is a third party that brokers a connector's auth (OAuth or API key) *and* hosts the MCP session on your tenant's behalf. Composio and Smithery ship today.
