...
Settings for the apps installed in this workspace. An app appears here only when its author registered a settings panel — otherwise it has no settings UI to surface.
