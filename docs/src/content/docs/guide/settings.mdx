...
The skills that shape your agent's behavior in this workspace, grouped by where they come from. **From your workspace** is the group you operate — the skills you own here sit on a card, and each row states at rest how it loads:
...
Toggle any owned skill on or off, or expand a row to read and edit its body. Skills inherited **from your organization** and **from the system** show below as read-only, collapsed groups. Your personal skills — which follow you across every workspace — surface as a footer link to your profile. Add a new always-on skill with **+ Add a skill**.
