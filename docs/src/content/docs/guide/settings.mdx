...
- **Workspace Instructions** — custom instructions injected into every conversation focused on this workspace, on top of any organization-wide policy. Only an **admin member of this workspace** can edit; everyone else reads — an organization admin who is not an admin member here gets no bypass.
