/**
 * AUTOGENERATED — DO NOT EDIT. Source: src/connectors/catalog/server-detail.ts
...
export declare const NIMBLEBRAIN_CONNECTOR_META_KEY = "ai.nimblebrain/connector";
/** Convenience accessor with the right type narrowing. */
export declare function getNimbleBrainConnectorMeta(s: ServerDetail): NimbleBrainConnectorMeta | undefined;
/**
 ...
 */
export declare const NIMBLEBRAIN_HOST_META_KEY = "ai.nimblebrain/host";
/** Convenience accessor for the host-integration extension. */
export declare function getNimbleBrainHostMeta(s: ServerDetail): HostManifestMeta | undefined;
/**
 ...
 */
export declare function connectorSkillIdentityFrom(composioToolkit: string | undefined, serverName: string): string;
/**
 ...
 */
export declare function connectorSkillIdentity(detail: ServerDetail): string;
...
export declare function validateServerDetail(candidate: unknown): ServerDetailValidation;
