/**
 * AUTOGENERATED — DO NOT EDIT. Source: src/bundles/connection.ts
 ...
 */
export declare function summarizeConnectionState(connections: Map<string, Connection>): BundleState;
