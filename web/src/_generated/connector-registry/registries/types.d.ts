/**
 * AUTOGENERATED — DO NOT EDIT. Source: src/registries/types.ts
...
import type { ComposioConnectorConfig, SecretHeaderRef, ServerDetail, SmitheryConnectorConfig } from "../connectors/catalog/server-detail.ts";
