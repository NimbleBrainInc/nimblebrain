/**
 * AUTOGENERATED — DO NOT EDIT. Source: src/notifications/types.ts
 ...
 */
export declare const NOTIFICATION_LEVEL_RANK: Readonly<Record<NotificationLevel, number>>;
/** The `_meta` key carrying everything this host renders and routes on. */
export declare const NOTIFICATION_META_KEY = "ai.nimblebrain/notification";
/** Level applied when an envelope declares none. */
export declare const DEFAULT_NOTIFICATION_LEVEL: NotificationLevel;
/** Plain-text caps. Longer values are truncated, never rejected. */
export declare const NOTIFICATION_TITLE_MAX = 200;
export declare const NOTIFICATION_BODY_MAX = 2000;
export declare const NOTIFICATION_SUBJECT_MAX = 200;
/**
 ...
 */
export declare function notificationId(item: Pick<Notification, "source"> & {
    envelope: Pick<NotificationEnvelope, "eventId">;
}): string;
/** Inverse of {@link notificationId}, or `null` when the string is not one. */
export declare function parseNotificationId(id: string): {
    source: string;
    eventId: string;
} | null;
/**
 ...
 */
export declare function notificationPresentation(envelope: NotificationEnvelope): NotificationPresentation;
/**
